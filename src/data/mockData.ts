...
export const mockPrizes: Prize[] = [
  // Базовые призы
  { id: 'prize1', name: '50 монет', image: '🪙', rarity: 'common', color: '#94A3B8', value: 50, dropChance: 40, description: 'Небольшое количество монет' },
  { id: 'prize2', name: '100 опыта', image: '⭐', rarity: 'common', color: '#94A3B8', value: 100, dropChance: 30, description: 'Немного опыта для прогресса' },
  { id: 'prize3', name: 'Базовый усилитель', image: '🔋', rarity: 'common', color: '#94A3B8', value: 75, dropChance: 20, description: 'Простой усилитель характеристик' },
  
  // Редкие призы
  { id: 'prize4', name: '200 монет', image: '💰', rarity: 'rare', color: '#3B82F6', value: 200, dropChance: 25, description: 'Хорошее количество монет' },
  { id: 'prize5', name: '300 опыта', image: '✨', rarity: 'rare', color: '#3B82F6', value: 300, dropChance: 20, description: 'Заметное количество опыта' },
  { id: 'prize6', name: 'Редкий артефакт', image: '🔮', rarity: 'rare', color: '#3B82F6', value: 250, dropChance: 15, description: 'Ценный артефакт с особыми свойствами' },
  
  // Эпические призы
  { id: 'prize7', name: '500 монет', image: '💎', rarity: 'epic', color: '#8B5CF6', value: 500, dropChance: 15, description: 'Внушительная сумма монет' },
  { id: 'prize8', name: '750 опыта', image: '🌟', rarity: 'epic', color: '#8B5CF6', value: 750, dropChance: 10, description: 'Большое количество опыта' },
  { id: 'prize9', name: 'Эпический амулет', image: '🏺', rarity: 'epic', color: '#8B5CF6', value: 600, dropChance: 8, description: 'Мощный амулет с уникальными способностями' },
  
  // Легендарные призы
  { id: 'prize10', name: '1000 монет', image: '👑', rarity: 'legendary', color: '#F59E0B', value: 1000, dropChance: 4, description: 'Огромная сумма монет' },
  { id: 'prize11', name: '1500 опыта', image: '💫', rarity: 'legendary', color: '#F59E0B', value: 1500, dropChance: 3, description: 'Колоссальное количество опыта' },
  { id: 'prize12', name: 'Легендарное оружие', image: '⚔️', rarity: 'legendary', color: '#F59E0B', value: 1200, dropChance: 2, description: 'Легендарное оружие невероятной силы' },
  
  // Мифические призы
  { id: 'prize13', name: '2500 монет', image: '🏆', rarity: 'mythic', color: '#EF4444', value: 2500, dropChance: 0.8, description: 'Мифическое богатство' },
  { id: 'prize14', name: '3000 опыта', image: '🔥', rarity: 'mythic', color: '#EF4444', value: 3000, dropChance: 0.5, description: 'Божественное количество опыта' },
  { id: 'prize15', name: 'Мифический артефакт', image: '🗿', rarity: 'mythic', color: '#EF4444', value: 2000, dropChance: 0.2, description: 'Артефакт древних богов' }
];
