...
export function ProfilePage({ onNavigate, currentPage, onOpenSettings, profilePhoto, setProfilePhoto, theme = 'light', battles = [], battleInvitations = [], personalBattles = [] }: ProfilePageProps) {
  ...
  // Placeholder данные для демонстрации структуры
