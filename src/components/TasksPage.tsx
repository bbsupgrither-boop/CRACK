        ...
        <div className="max-w-md mx-auto px-4 pb-32">
          <Panel
            ...
            leftIcon={
              ...
              >
                <Clock style={{ width: '16px', height: '16px', color: theme === 'dark' ? '#A7B0BD' : '#6B7280' }} />
              </button>
            }
            ...
            rightButton={
              ...
              >
                <Menu style={{ width: '16px', height: '16px', color: theme === 'dark' ? '#A7B0BD' : '#6B7280' }} />
              </button>
            }
          >
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex flex-col gap-2 min-w-[100px]">
                        <button
                          ...
                          className="px-4 py-2 text-sm font-medium transition-all hover:scale-[0.98]"
                          style={{
