...
export function ShopPageImageStyled({ 
  ...
  const [userBalance] = useState(13500); // Баланс как на изображении
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      {/* Иконка товара */}
                      <div 
                        className="w-12 h-12 flex items-center justify-center flex-shrink-0 cursor-pointer hover:scale-105 transition-transform"
                        style={{
                          backgroundColor: theme === 'dark' ? '#1C2029' : '#F3F5F8',
                          borderRadius: '16px'
                        }}
          ...
          {cartTab === 'cart' && cart.length > 0 && (
            ...
            >
              ...
              <span 
                ...
                style={{ color: theme === 'dark' ? '#E8ECF2' : '#0F172A' }}
              >
                {getTotalCartPrice().toLocaleString()}g
              </span>
            </div>
          )}
                      ...
                      >
                        ...
                        <div className="flex-1">
                          ...
                          <div 
                            ...
                            style={{ color: theme === 'dark' ? '#A7B0BD' : '#6B7280' }}
                          >
                            {item.price.toLocaleString()}g за шт.
                          </div>
                        </div>
      ...
      <ModalOpaque
        ...
        actions={
          selectedItem && selectedItem.stock > 0 && userBalance >= selectedItem.price ? (
            ...
            >
              Купить за {selectedItem.price.toLocaleString()}g
            </button>
