        ...
        <div className="text-center space-y-6">
          ...
          {isFreeAvailable ? (
            <button
              ...
              className="w-full py-4 px-6 rounded-xl font-bold tracking-wide transition-all duration-200 transform hover:scale-105 hover:shadow-lg"
              style={{
            ...
            >
              <div className="flex flex-col items-center text-center space-y-3">
                ...
                <div 
                  ...
                  style={{ 
                    background: `linear-gradient(145deg, ${caseType.color}15, ${caseType.color}05)`,
                    boxShadow: `0 0 30px ${caseType.color}40, inset 0 0 20px ${caseType.color}20`
                  }}
                ...
                >
                  ...
                  <div 
                    ...
                    style={{ 
                      ...
                      boxShadow: `inset 0 0 20px ${caseType.color}30`
                    }}
                  />
              ...
              >
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div 
                    ...
                    style={{ 
                      background: `linear-gradient(145deg, ${caseType.color}15, ${caseType.color}05)`,
                      boxShadow: `0 0 25px ${caseType.color}40, inset 0 0 15px ${caseType.color}20`
                    }}
                  >
                    <ImageOrEmoji
                      src={caseType.image}
                    ...
                    <div 
                      ...
                      style={{ 
                        border: `2px solid ${caseType.color}`,
                        boxShadow: `inset 0 0 15px ${caseType.color}30`
                      }}
                    />
                    {/* GRITHER логотип */}
                    <div 
                  ...
                  <button
                    ...
                    className="w-full py-2.5 px-4 rounded-xl font-bold text-sm tracking-wide transition-all duration-200 transform hover:scale-105 hover:shadow-lg"
                    style={{
  ...
  return (
    ...
    >
      ...
      <Modal
        ...
        title={openingCase ? `Открытие: ${cases.find(c => c.id === openingCase.caseTypeId)?.name}` : "Открытие кейса"}
        theme={theme}
      >
        <div className="space-y-6">
          {canSpin && (
